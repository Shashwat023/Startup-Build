...
# Weakness_Agent) all have a src/{models,crew,main}.py with the same names.
...
# from THIS project's src/ dir. This also fixes the same collision for
# test_pydantic.py's `from src.crew import BoardPanelCrew`, whose internal
# bare `from models import ...` was hitting a sibling project's models.py.
