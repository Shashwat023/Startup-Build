...
AGENT_PIPELINE = [
    {
        ...
        "display": "Finance Weaknesses",
        "result_key": "finance_weaknesses",
    },
    {
        "agent": "marketing_advisor",
        "task": "marketing_analysis_task",
        "display": "Marketing Weaknesses",
        "result_key": "marketing_weaknesses",
    },
    {
        "agent": "tech_lead",
        "task": "tech_analysis_task",
        "display": "Tech Weaknesses",
        "result_key": "tech_weaknesses",
    },
    {
        "agent": "org_hr_strategist",
        "task": "org_hr_analysis_task",
        "display": "Org/HR Weaknesses",
        "result_key": "org_hr_weaknesses",
    },
    {
        "agent": "competitive_analyst",
        "task": "competitive_analysis_task",
        "display": "Competitive Weaknesses",
        "result_key": "competitive_weaknesses",
    },
]
...
def extract_weaknesses_from_output(task_output, task_index: int) -> list:
    ...
    try:
        ...
        weaknesses_match = re.search(
            r'"weaknesses"\s*:\s*\[(.*?)\]', output_str, re.DOTALL
        )
        if weaknesses_match:
...
def get_fallback_weaknesses(task_index: int) -> list:
    ...
    return fallback_weaknesses.get(
        task_index,
        [
...
async def root():
    return {
        "status": "healthy",
        "service": "Board Panel - Weaknesses Analysis",
        "version": "2.0.0",
    }
